...
public class DoneChat extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_done_chat);
    ...
    private void viewMessage() {
        StringRequest request = new StringRequest(Request.Method.POST, "http://172.23.189.249/Log_In/commentFetch.php", new Response.Listener<String>() {
            @Override
