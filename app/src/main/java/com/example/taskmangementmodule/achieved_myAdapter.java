...
public class achieved_myAdapter extends RecyclerView.Adapter<achieved_myAdapter.aholder> {

        public static achievedmodel achievedmodeldata[];
        Context context;

        public achieved_myAdapter(achievedmodel achievedmodeldata[], Context context) {
        ...
        @NonNull
        @Override
        public achieved_myAdapter.aholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        @Override
        public void onBindViewHolder(@NonNull achieved_myAdapter.aholder holder, int position) {
            ...
            holder.duedate.setText(achievedmodeldata[position].getId());
...
//
//                    editor.putString("commentId", newtemp.getId());
//                    editor.apply();
                }
            });
        }
